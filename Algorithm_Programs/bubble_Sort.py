...
def bubble_sort_word():
    inps = input("Enter the String") #user input form keybord
    str_word = ref.create_str_to_word(inps) #Here string is convert word, calling function and pass theargument
    sort_word = ref.bubble_sort(str_word)  #here word are sorted, calling function and pass theargument
